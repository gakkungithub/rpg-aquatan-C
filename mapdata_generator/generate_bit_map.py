...
# class Room:
#     def __init__(self, nodeID: str, room_rect: tuple[int, int, int, int]):
#         self.nodeID = nodeID
...
# (itemPos, itemName, item_exp_info, var_type)
# (exp_terms, var_references, func_references, calc_order_comments, cursor.location.line)
class Treasure:
